...
/**
  * binary_tree_balance - Write a function that measures the balance factor of a binary tree
...
/**
  * binary_tree_is_perfect - Write a function that checks if a binary tree is perfect
